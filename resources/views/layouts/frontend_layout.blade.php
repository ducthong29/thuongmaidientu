...
<head>
    <title>Coffee Shop - Chuyên Cung Cấp Các Loại Cà Phê Đóng Gói</title>
    <meta charset="utf-8">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ route('Trangchu.index') }}">Coffee<small>Shop</small></a>
            {{-- ? --}}
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><span class="icon icon2 icon-phone"></span><span class="text"><a href="tel://0916 105 406">+84 1234567890</a> </span></li>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        ...
                        <a href="{{ route('Trangchu.index') }}" target="_blank">Admin
                            </a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
